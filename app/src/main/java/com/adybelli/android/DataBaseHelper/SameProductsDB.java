...
public class SameProductsDB extends SQLiteOpenHelper {
    private static final String DBNAME="samedb";
    private static final String TBNAME="same";
    public SameProductsDB(@Nullable Context context) {
    ...
    public Cursor getAll(String prod_id){
